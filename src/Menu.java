...
public class Menu{
    ...
    public void cria_itens(ArrayList<Item> menuList){
        ...
        menuList.add(7, new Item("Chá gelado", 8.90, "Natural, Cranberry, Limão, Maçã Verde", "440ml", true));
        menuList.add(8, new Item("Refrigerantes", 8.50, "Coca-Cola, Fanta(Laranja, Uva,) Sprite", "290ml", true));
